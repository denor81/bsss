...
I18N_MESSAGES["auto.upgrades.check.configured"]="Auto upgrades configured"
I18N_MESSAGES["auto.upgrades.check.not_configured"]="Auto upgrades not configured"
I18N_MESSAGES["auto.upgrades.backup.exists"]="Backup already exists: %s"
I18N_MESSAGES["auto.upgrades.backup.created"]="Backup created: %s"
I18N_MESSAGES["auto.upgrades.backup.missing_source"]="Source config missing, skipping backup: %s"
I18N_MESSAGES["auto.upgrades.backup.failed"]="Failed to create backup: %s [%s]"
I18N_MESSAGES["auto.upgrades.already_configured"]="Auto upgrades already configured"
I18N_MESSAGES["auto.upgrades.config.appended"]="Configuration block appended: %s"
I18N_MESSAGES["auto.upgrades.reconfigure.failed"]="Configuration error [dpkg-reconfigure unattended-upgrades]"
I18N_MESSAGES["auto.upgrades.menu.item_enable"]="Enable auto upgrades"
I18N_MESSAGES["auto.upgrades.menu.item_disable"]="Disable auto upgrades"
I18N_MESSAGES["auto.upgrades.restore.missing_backup"]="Backup not found, skipping restore: %s"
I18N_MESSAGES["auto.upgrades.restore.success"]="Backup restored: %s"
...
I18N_MESSAGES["swap.info.fstab_missing"]="Swap entry missing in fstab: %s"
I18N_MESSAGES["swap.info.fstab_removed"]="Swap entry removed from fstab: %s"
I18N_MESSAGES["swap.info.already_configured"]="Swap file already configured"
I18N_MESSAGES["swap.info.mkswap_done"]="Swap space initialized"
I18N_MESSAGES["swap.info.enabled"]="Swap file enabled"
I18N_MESSAGES["swap.info.disabled"]="Swap file disabled"
I18N_MESSAGES["swap.error.file_create"]="Failed to create swap file: %s"
I18N_MESSAGES["swap.error.file_missing"]="Swap file not found: %s"
I18N_MESSAGES["swap.error.fallocate_missing"]="fallocate command not found"
I18N_MESSAGES["swap.error.chmod_failed"]="Failed to set file permissions: %s"
I18N_MESSAGES["swap.error.fstab_missing"]="fstab file not found: %s"
I18N_MESSAGES["swap.error.fstab_add_failed"]="Failed to add entry to fstab: %s"
I18N_MESSAGES["swap.error.fstab_remove_failed"]="Failed to remove entry from fstab: %s"
I18N_MESSAGES["swap.error.mkswap_failed"]="Failed to initialize swap file: %s"
...
I18N_MESSAGES["common.helpers.rollback.stop_received"]="Received USR1 signal - stopping script due to rollback [SET RC: %s]"
...
I18N_MESSAGES["rollback.ready_received"]="rollback.sh is ready - close FIFO... %s"
