...
I18N_MESSAGES["rollback.timeout_ufw"]="По истечению таймера будет отключен UFW и сброшены его настройки"
I18N_MESSAGES["rollback.timeout_permissions"]="По истечению таймера будут удалены правила ${UTIL_NAME^^} для доступа"
I18N_MESSAGES["rollback.timeout_generic"]="По истечению таймера будут сброшены все настройки ${UTIL_NAME^^}"
...
I18N_MESSAGES["module.swap.name"]="Настройка swap файла"
I18N_MESSAGES["module.ipv6.name"]="Настройка IPv6"
...
# Auto upgrades check module
I18N_MESSAGES["auto.upgrades.check.configured"]="Автообновления настроены"
I18N_MESSAGES["auto.upgrades.check.not_configured"]="Автообновления не настроены"
I18N_MESSAGES["auto.upgrades.backup.exists"]="Бэкап уже существует: %s"
I18N_MESSAGES["auto.upgrades.backup.created"]="Создан бэкап: %s"
I18N_MESSAGES["auto.upgrades.backup.missing_source"]="Исходный конфиг отсутствует, пропуск бэкапа: %s"
I18N_MESSAGES["auto.upgrades.backup.failed"]="Не удалось создать бэкап: %s [%s]"
I18N_MESSAGES["auto.upgrades.already_configured"]="Автообновления уже настроены"
I18N_MESSAGES["auto.upgrades.config.appended"]="Добавлен блок настроек: %s"
I18N_MESSAGES["auto.upgrades.reconfigure.failed"]="Ошибка конфигурации [dpkg-reconfigure unattended-upgrades]"
I18N_MESSAGES["auto.upgrades.menu.item_enable"]="Включить автообновления"
I18N_MESSAGES["auto.upgrades.menu.item_disable"]="Отключить автообновления"
I18N_MESSAGES["auto.upgrades.restore.missing_backup"]="Бэкап не найден, пропуск восстановления: %s"
I18N_MESSAGES["auto.upgrades.restore.success"]="Восстановлен бэкап: %s"
I18N_MESSAGES["auto.upgrades.restore.failed"]="Не удалось восстановить файл: %s [%s]"

# Swap module
I18N_MESSAGES["swap.check.configured"]="Swap файл настроен (размер: %s)"
I18N_MESSAGES["swap.check.not_configured"]="Swap файл не настроен"
I18N_MESSAGES["swap.menu.item_enable"]="Включить swap файл"
I18N_MESSAGES["swap.menu.item_disable"]="Отключить swap файл"
I18N_MESSAGES["swap.ui.get_size.prompt"]="Введите размер swap файла"
I18N_MESSAGES["swap.ui.get_size.hint"]="Например: 1G или 512M, Enter для %s, 0 отмена"
I18N_MESSAGES["swap.info.disk_header"]="Место на диске"
I18N_MESSAGES["swap.info.disk_total_free"]="Всего: %s, Свободно: %s"
I18N_MESSAGES["swap.info.disk_total_free_swap"]="Всего: %s, Свободно: %s, Swap: %s"
I18N_MESSAGES["swap.info.size_unknown"]="неизвестен"
I18N_MESSAGES["swap.info.file_exists"]="Swap файл уже существует: %s"
I18N_MESSAGES["swap.info.file_recreate"]="Swap файл будет пересоздан: %s"
I18N_MESSAGES["swap.info.file_created"]="Swap файл создан: %s"
I18N_MESSAGES["swap.info.fstab_exists"]="Запись swap уже есть в fstab: %s"
I18N_MESSAGES["swap.info.fstab_added"]="Добавлена запись swap в fstab: %s"
I18N_MESSAGES["swap.info.fstab_missing"]="Запись swap в fstab отсутствует: %s"
I18N_MESSAGES["swap.info.fstab_removed"]="Запись swap удалена из fstab: %s"
I18N_MESSAGES["swap.info.already_configured"]="Swap файл уже настроен"
I18N_MESSAGES["swap.info.mkswap_done"]="Swap пространство инициализировано"
I18N_MESSAGES["swap.info.enabled"]="Swap файл включен"
I18N_MESSAGES["swap.info.disabled"]="Swap файл отключен"
I18N_MESSAGES["swap.error.file_create"]="Ошибка при создании swap файла: %s"
I18N_MESSAGES["swap.error.file_missing"]="Swap файл не найден: %s"
I18N_MESSAGES["swap.error.fallocate_missing"]="Команда fallocate не найдена"
I18N_MESSAGES["swap.error.chmod_failed"]="Ошибка при установке прав на файл: %s"
I18N_MESSAGES["swap.error.fstab_missing"]="Файл fstab не найден: %s"
I18N_MESSAGES["swap.error.fstab_add_failed"]="Ошибка при добавлении записи в fstab: %s"
I18N_MESSAGES["swap.error.fstab_remove_failed"]="Ошибка при удалении записи из fstab: %s"
I18N_MESSAGES["swap.error.mkswap_failed"]="Ошибка при инициализации swap файла: %s"
I18N_MESSAGES["swap.error.swapon_failed"]="Ошибка при активации swap файла: %s"
I18N_MESSAGES["swap.error.swapoff_failed"]="Ошибка при деактивации swap файла: %s"
I18N_MESSAGES["swap.error.disk_stats_failed"]="Не удалось получить данные о диске: %s"
I18N_MESSAGES["swap.error.size_invalid"]="Неверный размер swap файла: %s"
I18N_MESSAGES["swap.error.insufficient_space"]="Недостаточно места для swap: нужно %s, доступно %s"
I18N_MESSAGES["swap.warn.auto_setup_failed"]="Не удалось настроить swap; продолжаем без swap (%s)"

# IPv6 module
I18N_MESSAGES["ipv6.check.enabled"]="IPv6 включен (нет конфигурации ${UTIL_NAME^^})"
I18N_MESSAGES["ipv6.check.disabled"]="IPv6 отключен через конфигурацию ${UTIL_NAME^^}"
I18N_MESSAGES["ipv6.menu.item_enable"]="Включить IPv6"
I18N_MESSAGES["ipv6.menu.item_disable"]="Отключить IPv6"
I18N_MESSAGES["ipv6.info.config_created"]="Создан конфиг IPv6: %s"
I18N_MESSAGES["ipv6.error.update_grub_failed"]="Ошибка обновления grub: %s"
I18N_MESSAGES["ipv6.info.reboot_required"]="Создан файл требования перезагрузки: %s"
I18N_MESSAGES["ipv6.info.reboot_pkg_added"]="Обновлен список пакетов перезагрузки: %s -> %s"
...
I18N_MESSAGES["common.helpers.rollback.stop_received"]="Получен сигнал USR1 - остановка скрипта из-за отката [SET RC: %s]"
...
I18N_MESSAGES["auto.info.auto_upgrades"]="Автообновления и автоперезагрузка"
I18N_MESSAGES["auto.info.ipv6_disable"]="IPv6 отключен через grub.d"
I18N_MESSAGES["auto.info.swap_enable"]="Создание и активация swap файла"
