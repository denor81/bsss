...
if [[ "${BASH_SOURCE[0]}" == "${0}" ]]; then
    ...
    if [[ "${TEST_RUNNER_MODE:-}" == "1" ]]; then
        ...
        test_copy_installation_files_success || test_result=1
        test_copy_installation_files_no_dest_dir || test_result=1
        test_copy_installation_files_empty_source || test_result=1
        test_copy_installation_files_special_files || test_result=1
        test_copy_installation_files_with_spaces || test_result=1
        test_copy_installation_files_special_permissions || test_result=1
        test_copy_installation_files_large_files || test_result=1
        test_copy_installation_files_no_source_dir || test_result=1
