...
0. Всегда проверяй наличие файлов AGENTS.md в проекте и во вложенных каталогах (во вложенных каталогах это актуальные инструкции для текущего каталога). Используй AGENTS.md всегда.
